...
func get_plugin_info() uint32 {
	ensureInit()
	info := []byte(`{"name":"dprint-plugin-go-noop","version":"0.1.0","configKey":"go-noop","fileExtensions":["go"],"fileNames":[],"helpUrl":"","configSchemaUrl":""}`)
	return putShared(info)
}
